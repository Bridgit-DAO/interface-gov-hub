...
LAYER_TAGS_ENABLED = _env_bool('GOVHUB_LAYER_TAGS_ENABLED', 'true')
LAYER_TAG_FILTERS_ENABLED = _env_bool('GOVHUB_LAYER_TAG_FILTERS_ENABLED', 'true')
DOCUMENT_TAGS_ENABLED = _env_bool('GOVHUB_DOCUMENT_TAGS_ENABLED', 'true')
# Back-compat aliases
ARTIFACT_TAGS_ENABLED = LAYER_TAGS_ENABLED
ARTIFACT_TAG_FILTERS_ENABLED = LAYER_TAG_FILTERS_ENABLED
